import { Controller, Get, Param, Patch, Query, UseGuards, Body, Delete, Req } from '@nestjs/common';
...
export class UsersController {
    ...
    @Roles(UserRole.ADMIN)
    async assignSubject(@Param('id') id: string, @Body('subject') subject: string) {
